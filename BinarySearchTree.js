...
const Node = (_data, _leftNode = null, _rightNode = null) => {
    const data = _data;
    const leftChild = _leftNode;
    const rightChild = _rightNode;
...
const BinarySearchTree = (_arr = []) => {
  ...
  return {prettyPrint, insertNode, levelOrder, find, preorder, inorder, postorder,
